...
class Main():
    def __init__(self, screen):
        ...
        self.FPS = pygame.time.Clock()#fps controls the frame rate of the game loop. To regulate the speed of the game loop
    ...
    def _draw(self, maze, tile, player, game, clock):
        ...
        pygame.display.flip()#updates entire pygame display

    # main game loop
    def main(self, frame_size, tile):
        cols, rows = frame_size[0] // tile, frame_size[-1] // tile #framesize is in pixel...0 reps 1st and -1 reps last...cols,rows
        maze = Maze(cols, rows)
        ...
        while self.running:
            ...
            self.screen.fill( pygame.Color("darkslategray"), (603, 0, 752, 752))#used to create sidebar in the game
